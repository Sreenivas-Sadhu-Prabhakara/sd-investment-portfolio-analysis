package com.bank.bian.investmentportfolioanalysis.model;
...
/**
 * The BIAN control record for this service domain: "Portfolio Analysis Analysis".
 *
 ...
 * to its asset type (Portfolio Analysis). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Portfolio Analysis Analysis";
